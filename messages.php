...
<a class='button' href='messages.php?view=$view'>Refresh messages</a><br /><br />
_END;

    if (isset($_GET['erase'])) // move the refresh up, rather than at bottom... makes more sense
    {
    ...
    date_default_timezone_set('America/Los Angeles'); //not UTC ;)
    for ($j = 0 ; $j < $num ; ++$j)
    {
