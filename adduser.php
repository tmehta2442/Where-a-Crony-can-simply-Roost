...
echo "<html><head><title> Just enable Javascript :) </title>";

if ($fail == "") {
    echo "</head><body>Form data sucessfully validated, next you shit head: $forename,
...
function validate(form)
{
    ...
    fail        += validate(form.email.value)
    if (fail == "" ) return true
...
function validateUsername(field) {
    if (field == "") return "No Username was entered.\\n"
        ...
        return "Only a-z, A_Z, 0-9, _ and - are allowed in Usernames.\\n"
    return ""
}
...
function validatePassword(field) {
    if (field == "") return "No Password was entered"
        ...
        return "Password must be at least 6 characters.\\n"
            ...
            !/[0-9]/.test(field))
        return "Password must have at least each one of a-z, A-Z, 0-9.\\n"
    return ""
}

function validateAge(field) {
    if (field == "") return "No Age was entered"
    else if (field < 18 || field > 120)
...
function validate_username($field) {
    if ($field == "") return "No Username was entered<br />";
        ...
        return "Only letters, numbers, _ and - in usernames<br />";
    return "";
}
...
function validate_age($field) {
    if ($field == "") return "No age entered<br />";
        ...
        return "Age must be between 18 and 120<br />";
    return "";
}
